    ...
    <div className={styles.auth_container}>
      ...
      >
        <div className={styles.auth_left}>
          ...
          <svg
            className={styles.wave_overlay}
            viewBox="0 0 100 1000"
            preserveAspectRatio="none"
          >
            <path
              d="M100 0 H50 C 90 200, 0 400, 40 600 C 80 800, 20 900, 50 1000 H100 V0 Z"
              fill="#ffffff"
            />
          </svg>
          ...
          <div className={styles.auth_left_content}>
            ...
            >
              ...
              thoughts
              <br />
              <span className={styles.highlight}>organised.</span>
            </motion.h2>
            <motion.p
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
            ...
            >
              A simple, fast notes app to capture everything that matters. Focus
              on your ideas, we'll handle the rest.
            </motion.p>
          </div>
        </div>
        ...
        <div className={styles.auth_right}>
          ...
          >
            ...
            <div
              ...
              style={{ gridTemplateColumns: isLogin ? "1fr" : "1fr 1fr" }}
            >
              {!isLogin && (
                <>
